...
fn configureLibUsb(
    ...
    // Allow directly pinning an import/static archive for environments where
    // system lookup cannot resolve libusb naming conventions (for example MinGW).
...
pub fn build(b: *std.Build) void {
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "pxlobster" is the name you will use in your source code to
                // import this module (e.g. `@import("pxlobster")`). The name is
